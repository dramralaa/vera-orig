...
## ⚠️ ملاحظة حرجة للمزامنة المستقبلية
...
خارجي/كود تاجر" خالص**. الـ`sku` معرف داخلي عشوائي بيولّده هنجرستيشن نفسه
(مش كود جوليب). **الباركود هو المفتاح الوحيد الموثوق للربط بمنتجات جوليب/الصيدلية
الحقيقية** - أي مزامنة أسعار/كمية مستقبلية لازم تعتمد على الباركود حصرًا.
